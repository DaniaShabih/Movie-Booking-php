...
<div class="movie-items  full-width">
	<div class="row">
		<div class="col-md-12">
			<div class="title-hd">
				<h2>in theater</h2>
				<a href="MoviesGrid.php" class="viewall">View all <i class="ion-ios-arrow-right"></i></a>
			</div>
			<div class="tabs">
				<ul class="tab-links">
			            	...
			            	<div class="slick-multiItem2">
			            		<div class="slide-it">
			            			<div class="movie-item">
				            			...
				            			<div class="hvr-inner">
				            				<a  href="Book.php"> Book Now <i class="ion-android-arrow-dropright"></i> </a>
				            			</div>
				            			<div class="title-in">
			...
			<div class="col-md-9">
				...
				<div class="latestnewv2">
					...
					<div class="blog-item-style-2">
						...
						<div class="blog-it-infor">
							<h3><a href="#">First Official Images of Alicia Vikander As Tomb Raider’s Lara Croft</a></h3>
							<span class="time">27 Mar 2017</span>
					...
					<div class="blog-item-style-2">
						...
						<div class="blog-it-infor">
							<h3><a href="#">New Spider-Man: Homecoming Poster Finds Peter Parker At Rest</a></h3>
							<span class="time">27 Mar 2017</span>
					...
					<div class="blog-item-style-2">
						...
						<div class="blog-it-infor">
							<h3><a href="#">Joseph Gordon-Levitt Directing Moive Musical Comedy Wingmen</a></h3>
							<span class="time">27 Mar 2017</span>
